...
process.env.PUBLIC_API_BASE_URL = process.env.PUBLIC_API_BASE_URL ?? 'http://localhost:3000/api';
...
process.env.SUPERVISOR_NOTIFY_EMAIL = process.env.SUPERVISOR_NOTIFY_EMAIL ?? 'supervisor@example.com';
