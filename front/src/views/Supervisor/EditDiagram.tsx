          ...
          <div>
            ...
            {(pending || claimLevel) && (
              <div className="mt-1 flex flex-wrap gap-2 text-xs font-medium">
                {pending && (
                  <span className="inline-flex items-center gap-1 rounded-full border border-amber-200 bg-amber-50 px-3 py-0.5 text-amber-700">
      ...
      <div className="mx-auto w-full max-w-5xl p-6">
        ...
        <form ref={formRef} onSubmit={onSubmit} className="space-y-6">
          <div className="space-y-6">
            {questions.map((q, qi) => renderQuestionCard(q, qi))}
