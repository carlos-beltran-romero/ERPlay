  ...
  const finalizeExam = useCallback(
    async (reason: "submit" | "timeout" | "all-answered" | "unload") => {
      ...
      try {
        ...
        if (reason !== "unload")
          toast.error(e?.message || "No se pudo finalizar el examen");
      } finally {
  ...
  const startExamNow = async () => {
    ...
    try {
      ...
      try {
        ...
        if (rid0)
          await logTestEvent(data.sessionId, {
            type: "view_question",
            resultId: rid0,
            payload: { index: 0 },
          });
        ...
        <div className="mx-auto w-full max-w-3xl p-6">
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-gray-600">
              Lee atentamente las indicaciones antes de comenzar:
            </p>
            <ul className="mt-4 list-disc pl-6 space-y-2 text-gray-700">
              <li>
                Dispones de <strong>10 minutos</strong> para completar el
                examen.
              </li>
              <li>
                El examen contiene <strong>10</strong> preguntas seleccionadas
                al azar.
              </li>
              <li>
                <strong>No se puede volver a preguntas anteriores</strong>.
              </li>
              <li>
                <strong>
                  Una vez marques una respuesta, no podrás cambiarla
                </strong>
                .
              </li>
              <li>
                El examen se entregará automáticamente al terminar el tiempo o
